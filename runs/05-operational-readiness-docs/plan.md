...
`runs/05-operational-readiness-docs/spec.md` (versión 2).
...
- `runs/05-operational-readiness-docs/decision.md` (nuevo) — AC-8.
...
### 2.5 `runs/05-operational-readiness-docs/decision.md` (AC-8)
