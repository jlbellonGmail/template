...
- `runs/05-operational-readiness-docs/spec.md` (version 2, aprobada en
  `audit-2.md`)
- `runs/05-operational-readiness-docs/plan.md`
- `runs/05-operational-readiness-docs/tasks.md`
- `runs/05-operational-readiness-docs/audit-1.md` (rejected)
- `runs/05-operational-readiness-docs/audit-2.md` (approved)
