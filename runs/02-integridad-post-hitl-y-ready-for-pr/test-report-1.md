...
builder-agent) que la implementación de `runs/02-integridad-post-hitl-y-ready-for-pr/spec.md`
...
- `runs/02-integridad-post-hitl-y-ready-for-pr/decision.md` existe, no
