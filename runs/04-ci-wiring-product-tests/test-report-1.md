...
`feature/04-ci-wiring-product-tests`) contra `runs/04-ci-wiring-product-tests/spec.md`
...
`runs/04-ci-wiring-product-tests/decision.md` (98 líneas): tiene sección
...
`docs/usuario/index.md`, `runs/04-ci-wiring-product-tests/*.md`,
