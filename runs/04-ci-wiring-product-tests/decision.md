...
- `runs/04-ci-wiring-product-tests/spec.md`
- `runs/04-ci-wiring-product-tests/plan.md`
- `runs/04-ci-wiring-product-tests/tasks.md`
- `runs/04-ci-wiring-product-tests/audit-1.md` (rejected)
- `runs/04-ci-wiring-product-tests/audit-2.md` (approved)
