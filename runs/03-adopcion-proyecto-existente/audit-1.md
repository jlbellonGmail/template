...
- `runs/03-adopcion-proyecto-existente/decision.md` (AC-10) y enlaces exactos en `docs/tecnica/index.md`/`docs/usuario/index.md` vía `scripts/update-doc-indexes.ps1` (AC-9): exigidos explícitamente.
