...
- `runs/01-code-reviewer-y-sdd/spec.md`
- `runs/01-code-reviewer-y-sdd/plan.md`
- `runs/01-code-reviewer-y-sdd/tasks.md`
- `runs/01-code-reviewer-y-sdd/audit-1.md`
- `runs/01-code-reviewer-y-sdd/test-report-1.md`
- `runs/01-code-reviewer-y-sdd/code-review-1.md`
...
- `New-DecisionFile` ya no escribe "MERGE aprobado por evidencias del
  circuito agentico." Este mismo archivo (`runs/01-code-reviewer-y-sdd/
